...
public class Menu2 implements MenuCorrentista {
    ...
    @Override
    public void pOpcao(ContaInter no, Scanner salve) {
    ...
    @Override
    public void sOpcao(ContaInter no, Scanner salve) {
    ...
    @Override
    public void tOpcao(ContaInter no, Scanner salve, BancoInter b1) {
